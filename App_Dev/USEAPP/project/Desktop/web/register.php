...
<body>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="controller/createAccount.php" method="post" novalidate>
                    ...
                    <div class="col-12">
                    <label for="inputDate" class="col-12 col-form-label">Birth</label>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="login_attendroll.php">Log in</a></p>
                    </div>
                  </form>
  ...
  <script>
    <?php if (isset($_SESSION["status"]) && $_SESSION["status_code"] == "error"): ?>
    Swal.fire({
      icon: "error",
      title: "Error",
